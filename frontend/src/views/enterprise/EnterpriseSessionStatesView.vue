<template>
  <main class="state-page">
    ...
    <section class="page-content">
      ...
      <p class="intro">{{ activeState.description }}</p>
      <el-alert v-if="activeState.tone === 'danger' || activeState.tone === 'warning'" :title="activeState.title" :description="activeState.description" type="error" :closable="false" show-icon class="selected" />
      <div class="state-grid">
        <article v-for="state in states" :key="state.key" class="state-card" :class="state.tone">
