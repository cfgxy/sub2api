...
async function loadSummary() { try { summary.value = await enterpriseAPI.getWorkbenchSummary(params(undefined, true)); sourceStates.summary = 'ready' } catch { sourceStates.summary = 'unavailable'; throw new Error('summary') } }
