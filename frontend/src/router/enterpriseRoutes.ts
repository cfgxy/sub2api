...
export const enterpriseRoutes: RouteRecordRaw[] = [
  ...
  { path: '/enterprise/change-password', name: 'EnterpriseChangePassword', component: () => import('@/views/enterprise/EnterpriseChangePasswordView.vue'), meta: { requiresEnterpriseAuth: true, enterpriseRole: 'employee', title: '修改初始密码' } },
  {
    ...
    children: [
      { path: 'home', name: 'EnterpriseEmployeeHome', component: () => import('@/views/enterprise/EnterpriseEmployeeHomeView.vue'), meta: { requiresEnterpriseAuth: true, enterpriseRole: 'employee', title: '个人概览' } },
      { path: 'usage', name: 'EnterpriseEmployeeUsage', component: () => import('@/views/enterprise/EnterpriseEmployeeUsageView.vue'), meta: { requiresEnterpriseAuth: true, enterpriseRole: 'employee', title: '个人用量' } },
      { path: 'keys', name: 'EnterpriseKeys', component: () => import('@/views/enterprise/EnterpriseKeysView.vue'), meta: { requiresEnterpriseAuth: true, enterpriseRole: 'employee', title: 'API Key' } },
      { path: 'settings', name: 'EnterpriseEmployeeSettings', component: () => import('@/views/enterprise/EnterpriseEmployeeSettingsView.vue'), meta: { requiresEnterpriseAuth: true, enterpriseRole: 'employee', title: '个人设置' } },
      ...
      { path: 'admin/employees/:id', name: 'EnterpriseEmployeeDetail', component: () => import('@/views/enterprise/admin/EnterpriseEmployeeDetailView.vue'), meta: { requiresEnterpriseAuth: true, enterpriseRole: 'admin', title: '员工详情' } },
      ...
      { path: 'admin/workbench', name: 'EnterpriseWorkbench', component: () => import('@/views/enterprise/admin/EnterpriseWorkbenchView.vue'), meta: { requiresEnterpriseAuth: true, enterpriseRole: 'admin', title: '用量工作台' } },
      { path: 'admin/usage', name: 'EnterpriseAdminUsage', component: () => import('@/views/enterprise/admin/EnterpriseAdminUsageView.vue'), meta: { requiresEnterpriseAuth: true, enterpriseRole: 'admin', title: '企业用量' } },
      { path: 'admin/audit', name: 'EnterpriseAdminAudit', component: () => import('@/views/enterprise/admin/EnterpriseAdminAuditView.vue'), meta: { requiresEnterpriseAuth: true, enterpriseRole: 'admin', title: '管理审计' } },
      { path: 'admin/allocation', name: 'EnterpriseAllocation', component: () => import('@/views/enterprise/admin/EnterpriseAllocationView.vue'), meta: { requiresEnterpriseAuth: true, enterpriseRole: 'admin', title: '额度分配' } },
      { path: 'admin/keys', name: 'EnterpriseAdminKeys', component: () => import('@/views/enterprise/admin/EnterpriseAdminKeysView.vue'), meta: { requiresEnterpriseAuth: true, enterpriseRole: 'admin', title: '员工 Key' } },
