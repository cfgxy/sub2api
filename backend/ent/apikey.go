...
type APIKey struct {
	...
	// Whether usage from this key may require enterprise attribution
	EnterpriseAttributionCandidate bool `json:"enterprise_attribution_candidate,omitempty"`
...
func (*APIKey) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case apikey.FieldIPWhitelist, apikey.FieldIPBlacklist:
			values[i] = new([]byte)
		case apikey.FieldEnterpriseAttributionCandidate:
	...
	for i := range columns {
		...
		case apikey.FieldEnterpriseAttributionCandidate:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field enterprise_attribution_candidate", values[i])
			} else if value.Valid {
				_m.EnterpriseAttributionCandidate = value.Bool
			}
...
func (_m *APIKey) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("enterprise_attribution_candidate=")
	builder.WriteString(fmt.Sprintf("%v", _m.EnterpriseAttributionCandidate))
	builder.WriteString(", ")
