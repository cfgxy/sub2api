...
func (_u *APIKeyUpdate) SetEnterpriseAttributionCandidate(v bool) *APIKeyUpdate {
	_u.mutation.SetEnterpriseAttributionCandidate(v)
	return _u
}

// SetNillableEnterpriseAttributionCandidate sets the "enterprise_attribution_candidate" field if the given value is not nil.
func (_u *APIKeyUpdate) SetNillableEnterpriseAttributionCandidate(v *bool) *APIKeyUpdate {
	if v != nil {
		_u.SetEnterpriseAttributionCandidate(*v)
	}
	return _u
}
...
func (_u *APIKeyUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.EnterpriseAttributionCandidate(); ok {
...
// SetEnterpriseAttributionCandidate sets the "enterprise_attribution_candidate" field.
func (_u *APIKeyUpdateOne) SetEnterpriseAttributionCandidate(v bool) *APIKeyUpdateOne {
	_u.mutation.SetEnterpriseAttributionCandidate(v)
	return _u
}

// SetNillableEnterpriseAttributionCandidate sets the "enterprise_attribution_candidate" field if the given value is not nil.
func (_u *APIKeyUpdateOne) SetNillableEnterpriseAttributionCandidate(v *bool) *APIKeyUpdateOne {
	if v != nil {
		_u.SetEnterpriseAttributionCandidate(*v)
	}
	return _u
