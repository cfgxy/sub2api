...
func init() {
	...
	// apikeyDescEnterpriseAttributionCandidate is the schema descriptor for enterprise_attribution_candidate field.
	apikeyDescEnterpriseAttributionCandidate := apikeyFields[5].Descriptor()
	// apikey.DefaultEnterpriseAttributionCandidate holds the default value on creation for the enterprise_attribution_candidate field.
	apikey.DefaultEnterpriseAttributionCandidate = apikeyDescEnterpriseAttributionCandidate.Default.(bool)
