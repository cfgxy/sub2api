...
const apiKeyAuthSnapshotVersion = 25 // v25: merged upstream v24 (group model_allowlist rename) + enterprise v24 (attribution candidate); bump invalidates both prior lineages
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	snapshot := &APIKeyAuthSnapshot{
		...
		EnterpriseAttributionCandidate: apiKey.EnterpriseAttributionCandidate,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	apiKey := &APIKey{
		...
		EnterpriseAttributionCandidate: snapshot.EnterpriseAttributionCandidate,
